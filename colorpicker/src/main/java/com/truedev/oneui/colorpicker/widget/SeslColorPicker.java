...
import com.truedev.oneui.colorpicker.R;
...
public class SeslColorPicker extends LinearLayout
    ...
    private final OnClickListener mImageButtonClickListener = new OnClickListener() {
        @Override
    ...
    private void initColorSpectrumView() {
        ...
        mColorPickerSaturationEditText.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
    ...
    private void initGradientColorSeekBar() {
        ...
        mGradientColorSeekBar.setOnTouchListener(new OnTouchListener() {
            @Override
    ...
    public void initOpacitySeekBar(boolean enabled) {
        ...
        mOpacitySeekBar.setOnTouchListener(new OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                mColorPickerOpacityEditText.setTag(1);
